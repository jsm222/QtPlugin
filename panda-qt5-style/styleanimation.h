...
class NumberStyleAnimation : public StyleAnimation
{
    Q_OBJECT

public:
    NumberStyleAnimation(QObject *target);
...
class BlendStyleAnimation : public StyleAnimation
{
    Q_OBJECT
...
public:
    ...
    BlendStyleAnimation(Type type, QObject *target);
...
class ScrollbarStyleAnimation : public NumberStyleAnimation
{
    Q_OBJECT
...
public:
    ...
    ScrollbarStyleAnimation(Mode mode, QObject *target);
